...
public class RelationsInSentence {
	 ...
	 */
	private HashMap<String, List<String>> nerTaggedEntityMap;
	private String sentence;
	private int entityCount;
	
	public RelationsInSentence(String sourceSentence) {
		this.nerTaggedEntityMap = new HashMap<>(7); 
		this.sentence = sourceSentence;
		this.entityCount = 0;
	}
	 ...
	 */
	public boolean addEntity(String entityName, String entityType) throws IllegalArgumentException {
		...
		if(nerTaggedEntityMap.containsKey(entityType)) {
			List<String> entityList = nerTaggedEntityMap.get(entityType);
	 ...
	 */
	private boolean containsSimilarEntity(List<String> entityList, String entityName) {
	...
	public boolean isEmpty() {
		return (entityCount > 1) && (nerTaggedEntityMap.get("PERSON") == null && nerTaggedEntityMap.get("ORGANIZATION") == null);
	}
